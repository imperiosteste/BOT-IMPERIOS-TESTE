...
inicio2.add(
    ...
    InlineKeyboardButton('❔ Suporte', url='https://t.me/Redzinvenda'))
inicio2.row_width = 1
inicio2.add(InlineKeyboardButton('👥 Grupo', url='https://t.me/redzinchat'))
...
def cc_comp(id_user):
	...
	u.row_width = 1
	u.add(
    InlineKeyboardButton('☑️ Menu Inicial', url=f'https://t.me/RedzinVendSBot?start={id_user}'))
	return u
